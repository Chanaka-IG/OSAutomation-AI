...
1. `orangehrm-opensource-domain` skill — Start here for overview and data models
2. `orangehrm-opensource-domain` sub-files — Read `./business-rules.md` and `./user-flows.md` for detailed rules and flows
